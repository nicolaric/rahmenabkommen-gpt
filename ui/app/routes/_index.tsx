          ...
          <div className="flex flex-col items-center justify-center w-full h-full">
            <div className="flex flex-col gap-4 max-w-[48rem] w-11/12">
              ...
              <div className="fixed left-0 bottom-0 flex justify-center bg-gray-50 items-center w-full">
                <div className="w-11/12 max-w-[48rem] md:h-32 h-24 p-2 pt-5 mb-4 bg-white border border-gray-300 rounded-3xl shadow-sm flex flex-col">
                  <textarea
                    className="w-full h-4 md:h-24 flex-grow px-2 resize-none focus:outline-none bg-white"
                    placeholder="Stelle deine Frage zum Rahmenabkommen..."
                    value={message}
                    onChange={(e) => setMessage(e.target.value)}
                    onKeyDown={(e) => {
